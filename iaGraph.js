function iaGraphFct(nbLight) {
    var w = (iaGraph.width = window.innerWidth),
        h = (iaGraph.height = window.innerHeight),
        ctx = iaGraph.getContext("2d"),
        opts = {
            len: 20,
            count: nbLight,
            baseTime: 10,
    ...
    window.addEventListener("resize", function () {
        w = iaGraph.width = window.innerWidth;
        h = iaGraph.height = window.innerHeight;
        ctx.fillStyle = "black";
        ctx.fillRect(0, 0, w, h);
